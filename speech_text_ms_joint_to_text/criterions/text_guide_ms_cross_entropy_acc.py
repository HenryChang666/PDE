...
@register_criterion("guided_label_smoothed_cross_entropy_with_accuracy_with_ctc")
class GuidedCrossEntAccCTCCriterion(FairseqCriterion):
    def __init__(
        self,
        task,
        sentence_avg,
    ...
    def forward(self, model, sample, reduce=True):
        ...
        sample_size, logging_output = self.get_logging_output(
            sample, loss, ctc_loss, nll_loss, correct, total, src_token_num, speech_loss, speech_nll_loss, is_dual_input
        )
